""" Defines the BOARD class for NTC C.H.I.P. that contains the board pin mappings. """
...
class BOARD:
    ...
    LED  = "XIO-P0"   # CHIP GPIO 18 connects to the LED on the proto shield
    SWITCH = 4  # CHIP GPIO 4 connects to a switch
